...
class PlanDashboard < Administrate::BaseDashboard
  ATTRIBUTE_TYPES = {
    ...
    monthly_price_cents: MoneyCentsField,
    annual_price_cents: MoneyCentsField,
    setup_fee_cents: MoneyCentsField,
    promo_price_cents: MoneyCentsField,
    promo_months_count: Field::Number,
    ai_credits_included: Field::Number,
    ai_credit_overage_price_cents: MoneyCentsField,
