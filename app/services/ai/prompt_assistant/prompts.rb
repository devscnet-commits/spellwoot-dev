...
# blocos Objetivo/Regras/Fala sugerida em markdown e virou 3 CAMPOS JSON separados (objective/rules
# array/suggested_script), espelhando os 3 campos que a tela agora tem (Ai::StepForm.vue) —
# Ai::PromptAssistant#suggest faz o parse desses 3 campos em vez de extrair um {"suggestion"} único.
# Reescrito de novo (2026-08, bug ao vivo: a IA leu um "AVISO: CRIE A VARIÁVEL..." como se fosse
# instrução de comportamento e ficou confusa): objective/rules/suggested_script vão DIRETO pro
# system_prompt da IA — não podem mais conter nenhum texto dirigido ao admin humano. 4º campo,
# admin_warnings (array), é o único lugar pra esse tipo de aviso; AiPromptAssistant.vue mostra à
...
# mais texto de "chame a ferramenta X" nenhum.
