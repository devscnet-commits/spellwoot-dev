      ...
      <div class="flex-1 flex flex-col gap-1.5">
        <template v-if="enabled">
          ...
          >
            ...
            <span
class="text-n-slate-11 text-sm" :class="{ 'mt-5': idx === 0 }"
              >→</span
            >
            <div class="flex flex-col gap-0.5">
              <span v-if="idx === 0" class="text-label-small text-n-slate-10">
            ...
            <span
              v-if="hasError(period)"
              class="text-label-small text-n-ruby-9"
            >
      ...
      <div
        v-if="enabled"
        class="flex items-center gap-1 flex-shrink-0 pt-0.5 relative"
      >
        <!-- Templates -->
        <div class="relative">
          <button
        ...
        <div class="relative">
          ...
          >
            <p
              class="px-4 py-1 text-label-small text-n-slate-10 font-medium uppercase"
            >
