...
#  index_ai_runs_on_account_id_and_created_at  (account_id,created_at)
...
class Ai::Run < ApplicationRecord
  ...
  ERROR_TYPES = %w[
    ...
    guardrail_blocked budget_exceeded classification_failed unparsed_decision internal_error unknown
  ].freeze
