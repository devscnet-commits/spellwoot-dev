...
RSpec.describe Ai::StepInstructionText do
  describe '.render' do
    ...
    it 'etapa NOVA (objective/rules): monta o bloco estruturado' do
      step = {
    ...
    it 'etapa NOVA com só objective (sem rules): omite o bloco vazio' do
    ...
    it 'aceita chaves symbol (mesma tolerância do resto do codebase)' do
      step = { objective: 'Via symbol', rules: ['Regra via symbol'] }
    ...
    # ETAPA ANTIGA: nenhum dos 2 campos novos preenchido -> cai no texto livre de instructions,
    ...
    it 'objective/rules presentes (mesmo 1 só) tomam PRECEDÊNCIA sobre instructions legado' do
